...
SELECT wypoz_id, dbo.w2_zasoby_t.zasob_id, uzytk_id, dbo.w2_zasoby_t.grupa_id, opis, autor, syg, all_sygnat.numer_inw, k_kreskowy, limit_czasu, data_wypoz, data_zwrot,
syg_expand, numer_inw_expand, sort_order,
...
INNER JOIN dbo.w2_zasoby_t ON CAST(obcy_id AS int) = all_sygnat.id_zasob
